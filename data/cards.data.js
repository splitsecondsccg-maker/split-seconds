...
(function(){
  window.SS_CARDS_DATA = {
    ...
    ice_assassin_ice_dagger:{ id: "ice_assassin_ice_dagger", name: "Ice Dagger", type: "attack", cost: 0, moments: 1, dmg: 2, desc: "2 DMG. On hit: FREEZE 1.", effect: "freeze_1_on_hit", requirements: {'all': ['assassin', 'ice']} },
    ...
    warrior_shield_discipline:{ id: "warrior_shield_discipline", name: "Shield Discipline", type: "buff", cost: 1, moments: 1, dmg: 0, desc: "Reduce incoming damage by 3 this moment.", effect: "reduce_dmg_3", requirements: {'all': ['warrior']} },
    light_sanctified_burst:   { id: "light_sanctified_burst", name: "Sanctified Burst", type: "attack", cost: 2, moments: 2, dmg: 4, desc: "4 DMG. On hit: heal 1.", effect: "heal_1_on_hit", requirements: {'all': ['light']} },
    ...
    wizard_arcane_focus:      { id: "wizard_arcane_focus", name: "Arcane Focus", type: "utility", cost: 1, moments: 1, dmg: 0, desc: "Gain 1 Stamina.", effect: "gain_stam_1", requirements: {'all': ['wizard']} },
    darkness_dread_mark:      { id: "darkness_dread_mark", name: "Dread Mark", type: "buff", cost: 1, moments: 1, dmg: 0, desc: "Draw 1. Opponent must block next turn.", effect: "scare", requirements: {'all': ['darkness']} },
    ...
    vampire_blood_sip:        { id: "vampire_blood_sip", name: "Blood Sip", type: "grab", cost: 1, moments: 1, dmg: 2, desc: "2 DMG. On hit: heal 1.", effect: "heal_1_on_hit", requirements: {'all': ['vampire']} },
    ...
    hypnotic_false_command:   { id: "hypnotic_false_command", name: "False Command", type: "utility", cost: 1, moments: 1, dmg: 0, desc: "Apply HYPNOTIZED.", effect: "hypnotize", requirements: {'all': ['hypnotic']} },
    fae_mirror_prank:         { id: "fae_mirror_prank", name: "Mirror Prank", type: "buff", cost: 1, moments: 1, dmg: 0, desc: "If opponent resolves an ATTACK this moment: negate it, draw 1, and deal 3 DMG.", effect: "blink", requirements: {'all': ['fae']} },
    ice_frostbind:            { id: "ice_frostbind", name: "Frostbind", type: "attack", cost: 1, moments: 1, dmg: 2, desc: "2 DMG. On hit: FREEZE 1.", effect: "freeze_1_on_hit", requirements: {'all': ['ice']} },
    ...
    spirit_ether_guard:       { id: "spirit_ether_guard", name: "Ether Guard", type: "buff", cost: 1, moments: 1, dmg: 0, desc: "Next turn: +2 Armor.", effect: "spirit_form", requirements: {'all': ['spirit']} },
    ...
    toxic_rain: {
      ...
      desc: "POISON 6.", effects: [{ type: "poison", value: 6 }]
    },
    vamp_rending_claw: {
    ...
    ability_paladin_1: { id: "ability_paladin_1", name: "Holy Light", type: "buff", cost: 1, moments: 1, dmg: 0, desc: "Heal 2 HP", effect: "heal_2", isBasic: true, isAbility: true },
    ...
    ability_vampiress_1: { id: "ability_vampiress_1", name: "Blood Frenzy", type: "utility", cost: 0, moments: 1, dmg: 0, desc: "Draw 1 Card", effect: "draw_1", isBasic: true, isAbility: true },
    ability_vampiress_2: { id: "ability_vampiress_2", name: "Draw Blood", type: "attack", cost: 0, moments: 1, dmg: 1, desc: "Upon hit: Next Atk +1", effect: "draw_blood", isBasic: true, isAbility: true },

    ability_necromancer_1: { id: "ability_necromancer_1", name: "Meditate", type: "utility", cost: 0, moments: 2, dmg: 0, desc: "Draw 1, Gain 2 Stamina", effect: "meditate", isBasic: true, isAbility: true },
    ...
    ability_ice_assassin_1: { id: "ability_ice_assassin_1", name: "Ice Slash", type: "attack", cost: 2, moments: 1, dmg: 3, desc: "3 DMG. On hit: FREEZE 1.", effect: "freeze_1_on_hit", isBasic: true, isAbility: true },
    ability_ice_assassin_2: { id: "ability_ice_assassin_2", name: "Ice Forge", type: "buff", cost: 0, moments: 1, dmg: 0, desc: "Create Ice Dagger in hand.", effect: "forge_ice_dagger", isBasic: true, isAbility: true },
