...
function clearAllGlowsAndHighlights() {
    ...
    // Clear flash highlight + any timeline resolve highlights
    document.querySelectorAll('.slot').forEach(s => s.classList.remove('flash-highlight', 'tutorial-highlight', 'resolving-slot'));
